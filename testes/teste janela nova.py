...
tipos_possiveis_pessoas = ["Pessoa Física", "Pessoa Jurídica"]
...
lb_cidade = Label(separador6, text="Cidade", font=lb_style)
lb_cidade.grid(column=0, row=4, sticky="W", padx=paddingx)
entry_cidade = Entry(separador6, font=entry_style,width=5, state=DISABLED)
