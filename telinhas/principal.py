...
class Funcs():
    def __init__(self):
        ...
        self.janela_pessoas_var = None #certo
        self.janela_trabalhos_var = None #certo
        self.lista_de_pessoas = None #certo
        self.lista_de_trabalhos = None #certo
        self.lista_planos = None
        self.argumentos = None #certo 1
        self.nome_pessoa_trabalho = None #certo
        self.codigo_pessoa_trabalho = None #certo
        self.codigo_tipo_trabalho = None #certo
        self.nome_tipo_trabalho = None #certo
        self.codigo_plano_trabalho = None #certo
        self.nome_plano_trabalho = None #certo
        self.valores_pagamento = [] #certo
